...
A BPL message has exactly two layers: 1. Signal Header — normative, authoritative 2. Payload — free-form, non-authoritative
...
Given a valid BPL header: 1. Header is parsed before payload 2. Reasoning is configured only from header 3. Payload inherits all declared constraints 4. No undeclared axis may be assumed
